...
if __name__ == "__main__":
    ...
    file_handler = logging.FileHandler("../logs/answers_self_metadata.log", mode="w")
    ...
    input_file = "./results_self_metadata.tsv"
    processed_file_location = "./TEMP_processed_test_self_metadata.tsv"
    runner = OpenAIBatchRunner(OPENAI_API_KEY, SYSTEM_PROMPT, json_schema=SCHEMA, input_file=input_file,
                               batch_folder="./batch_self_metadata/")
    ...
    process_output_data_for_finetuned_models(output_data, processed_file_location, "qa_selfcaption_metadata.tsv")
