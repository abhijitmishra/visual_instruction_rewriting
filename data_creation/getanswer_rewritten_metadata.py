...
if __name__ == "__main__":
    ...
    file_handler = logging.FileHandler("../logs/answers_metadata.log", mode="w")
    ...
    input_file = "./results_metadata.tsv"
    processed_file_location = "./TEMP_processed_test_metadata.tsv"
    runner = OpenAIBatchRunner(OPENAI_API_KEY, SYSTEM_PROMPT, json_schema=SCHEMA, input_file=input_file,
                               batch_folder="./batch_metadata/")
    ...
    process_output_data_for_finetuned_models(output_data, processed_file_location, "qa_metadata.tsv")
