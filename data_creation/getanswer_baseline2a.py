...
if __name__ == "__main__":
    ...
    file_handler = logging.FileHandler("../logs/answers_paligemma_self_caption_easyocr.log", mode="w")
    ...
    input_file = "./results_paligemma_self_caption_easyocr.tsv"
    processed_file_location = "./TEMP_processed_test_paligemma_self_caption_easyocr.tsv"
    runner = OpenAIBatchRunner(OPENAI_API_KEY, SYSTEM_PROMPT, json_schema=SCHEMA, input_file=input_file,
                               batch_folder="./batch_paligemma_self_caption_easyocr/")
    ...
    process_output_data_for_finetuned_models(output_data, processed_file_location, "./qa_paligemma_self_caption_easyocr.tsv")
