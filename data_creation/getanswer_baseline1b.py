...
if __name__ == "__main__":
    ...
    file_handler = logging.FileHandler("../logs/answers_qwen.log", mode="w")
    ...
    input_file = "./results_qwen.tsv"
    processed_file_location = "./TEMP_processed_test_qwen.tsv"
    runner = OpenAIBatchRunner(OPENAI_API_KEY, SYSTEM_PROMPT, json_schema=SCHEMA, input_file=input_file,
                               batch_folder="./batch_qwen/")
    ...
    process_output_data_for_finetuned_models(output_data, processed_file_location, "./qa_qwen.tsv")
